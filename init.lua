...
-- TODO: map those in order to move and format text properly
vim.keymap.set('n', 'Ï', '<cmd>m .+1<CR>==', { desc = 'Move line down' })
vim.keymap.set('n', 'È', '<cmd>m .-2<CR>==', { desc = 'Move line up' })
vim.keymap.set('i', 'Ï', '<Esc><cmd>m+<CR>==gi', { desc = 'Move line down' })
vim.keymap.set('i', 'È', '<Esc><cmd>m-2<CR>==gi', { desc = 'Move line up' })
vim.keymap.set('v', 'Ï', "<cmd>m '>+1<CR>gv=gv", { desc = 'Move block down' })
vim.keymap.set('v', 'È', "<cmd>m '<-2<CR>gv=gv", { desc = 'Move block up' })
--
...
require('lazy').setup({
  ...
  -- NOTE: How to add the debugging capabilities
